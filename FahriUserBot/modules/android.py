...
CMD_HELP.update(
    {
        "android": ">;magisk"
        "\nTo Get the latest MAGISK release"
        "\n\n>;device <codename>"
        "\nexplanation: Get info about android device codename or model."
        "\n\n>;codename <brand> <device>"
        "\nexplanation: Find Android device codename."
        "\n\n>;pixeldl **<download.pixelexperience.org>**"
        "\nexplanation: Download pixel experience ROM to your userbot cerver ."
        "\n\n>;specs <brand> <device>"
        "\nexplanation: To get device specification info."
        "\n\n>;twrp <codename>"
        "\nexplanation:Get latest version of twrp download for android device."
    }
)
