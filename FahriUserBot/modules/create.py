    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "gb":
            try:
                ...
                await grop.edit("my master, Group/Channel {} succesfully created. Click [{}]({}) to look".format(group_name, group_name, result.link))
...
CMD_HELP.update({
    "creating": "\
creating\
\nexplanation: for creat Channel, Group and Group with Bot.\
\n\n;create g <group name>\
\nexplanation: creat your group.\
\n\n;create gb <group name>\
\nexplanation: creat group with bot.\
\n\n;create c < channel name>\
\nexplanation: creat a channel.\
"})
