...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("please reply to image master")
        return
    ...
    if photo:
        ...
        try:
            ...
            await img.edit('Image not supported')
            return
        name = "okgoogle.png"
        image.save(name, "PNG")
        image.close()
